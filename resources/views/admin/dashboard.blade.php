                    ...
                    <div class="widget-content d-flex justify-content-between align-items-center">
                        ...
                        <div class="w-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="feather feather-wallet">
                                <path
                                    d="M20 7v-2a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v2m0 0h16m-16 0l-1 10h18l-1-10m-16 0a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6a2 2 0 0 0-2-2H4z">
                                </path>
                            </svg>
                        </div>
                    </div>
                    ...
                    <div class="widget-content d-flex justify-content-between align-items-center">
                        ...
                        <div class="w-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                <path
                                    d="M12 1v22m-4-3h8c1.38 0 2.5-1.12 2.5-2.5S17.38 15 16 15H8c-1.38 0-2.5 1.12-2.5 2.5S6.62 20 8 20h8">
                                </path>
                                <path
                                    d="M11 5h2c1.38 0 2.5 1.12 2.5 2.5S14.38 10 13 10h-2c-1.38 0-2.5-1.12-2.5-2.5S9.62 5 11 5z">
                                </path>
                            </svg>
                        </div>
                    </div>
                    ...
                    <div class="widget-content d-flex justify-content-between align-items-center">
                        ...
                        <div class="w-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                <path d="M12 2l10 7-10 7-10-7 10-7zm0 18l10-7-10-7-10 7 10 7z"></path>
                            </svg>
                        </div>
                    </div>
                </div>
                ...
                <div class="widget widget-card-four" style="cursor: pointer;">
                    <div class="widget-content d-flex justify-content-between align-items-center">
                        ...
                        <div class="w-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="feather feather-signal">
                                <path d="M2 12a10 10 0 0 1 10-10m0 0a10 10 0 0 1 10 10m-10-10v20"></path>
                            </svg>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="widget-content d-flex justify-content-between align-items-center">
                        ...
                        <div class="w-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                <path
                                    d="M3 3h6v6H3V3zm0 8h6v6H3v-6zm8-8h6v6h-6V3zm0 8h6v6h-6v-6zm-8 8h6v-6H3v6zm8 0h6v-6h-6v6z">
                                </path>
                            </svg>
                        </div>
                    </div>
