    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                ...
                "metadata": ["map"],
                "once_per_event": true,
                "vtp_html": "\u003Cscript type=\"text\/gtmscript\"\u003Econsole.log(\"PI:GTM Worked!\");\u003C\/script\u003E",
        ...
        "runtime": [[50, "__e", [46, "a"], [36, [13, [41, "$0"], [3, "$0", ["require", "internal.getEventData"]], ["$0", "event"]]]], [50, "__html", [46, "a"], [52, "b", ["require", "internal.injectHtml"]], ["b", [17, [15, "a"], "html"], [17, [15, "a"], "gtmOnSuccess"], [17, [15, "a"], "gtmOnFailure"], [17, [15, "a"], "useIframe"], [17, [15, "a"], "supportDocumentWrite"]]]
        ],
        "entities": {
            "__e": {
                "2": true,
...
*/
    ...
    ;
    function Ha(a, b) {
        for (var c, d = l(b), e = d.next(); !e.done && !(c = Ia(a, e.value),
...
*/
    ...
    function xc(a) {
        var b = E.createElement("div"), c = b, d, e = dc("A<div>" + a + "</div>"), f = Gb();
...
*/
    var Oc = /\[object (Boolean|Number|String|Function|Array|Date|RegExp)\]/
      ...
      , Rc = function(a) {
        if (!a || Pc(a) != "object" || a.nodeType || a == a.window)
            return !1;
        try {
      ...
      , Sc = function(a, b) {
        ...
        for (d in a)
            if (Qc(a, d)) {
                var e = a[d];
                Pc(e) == "array" ? (Pc(c[d]) != "array" && (c[d] = []),
                c[d] = Sc(e, c[d])) : Rc(e) ? (Rc(c[d]) || (c[d] = {}),
                c[d] = Sc(e, c[d])) : c[d] = e
            }
        return c
    };
    function Tc(a) {
        if (a == void 0 || Array.isArray(a) || Rc(a))
            return !0;
        switch (typeof a) {
        case "boolean":
        case "number":
    ...
    ;var Vc = function(a) {
        ...
        this.na = !1;
        for (var b in a)
            a.hasOwnProperty(b) && (Uc(b) ? this.values[Number(b)] = a[Number(b)] : this.T.set(b, a[b]))
    };
    h = Vc.prototype;
    h.toString = function(a) {
        ...
        for (var b = [], c = 0; c < this.values.length; c++) {
            var d = this.values[c];
            d === null || d === void 0 ? b.push("") : d instanceof Vc ? (a = a || [],
            a.push(this),
            b.push(d.toString(a)),
    ...
    h.set = function(a, b) {
        if (!this.na)
            if (a === "length") {
                ...
                Uc(a) ? this.values[Number(a)] = b : this.T.set(a, b)
    }
    ;
    h.get = function(a) {
    ...
    ;var gd = {
        ...
        reverse: function() {
            for (var a = Wc(this), b = a.length - 1, c = 0; b >= 0; b--,
            c++)
    ...
    function Md(a, b) {
        ...
        if (a instanceof Ka || a instanceof dd || a instanceof Vc || a instanceof Xc)
            c = a.get(b);
    ...
    ;
    function Be(a) {
        if (a instanceof za || a instanceof Xc || a instanceof Vc || a instanceof Ka || a instanceof dd || a instanceof bd || a === null || a === void 0 || typeof a === "string" || typeof a === "number" || typeof a === "boolean")
            return a
    }
    ;var De = function(a) {
        this.message = a
    ...
    var vf = function(a, b, c) {
      ...
      , yf = function(a, b) {
        ...
        for (m in a)
            a.hasOwnProperty(m) && ub(m, "vtp_") && (e && (g[m] = a[m]),
    ...
    var ig = function(a, b) {
        for (var c = 0; c < b.length; c++) {
            ...
            if (!m || k.length > d.length || !g && d.length !== e.length ? 0 : g ? ub(d, k) && (d === k || d.charAt(k.length) === ".") : d === k)
                return !0
        }
        return !1
    }
    ...
    function Eh(a, b) {
        if (a) {
            var c = a.split("x");
            c.length === 2 && (Fh(b, "u_w", c[0]),
            Fh(b, "u_h", c[1]))
        }
    }
    function Gh(a, b) {
        a && (a.length === 2 ? Fh(b, "hl", a) : a.length === 5 && (Fh(b, "hl", a.substring(0, 2)),
        Fh(b, "gl", a.substring(3, 5))))
    }
    function Hh(a) {
        var b = Ih;
        b = b === void 0 ? Jh : b;
    ...
    Fi.Ce = Number("0") || 0;
    Fi.ob = "dataLayer";
    Fi.yn = "ChAI8LKHuQYQpKmQ47CltME1EiQACL6CqBkBlFy4TucsYXL+fQ5G2ODJ+HiaXze9QIj3Q+wJZWsaAplb";
    var Hi = {
        __cl: 1,
        __ecl: 1,
        __ehl: 1,
    ...
    for (Ji in Hi)
        Hi.hasOwnProperty(Ji) && (Ii[Ji] = 1);
    var Ki = lb(""), Li = !1, Mi, Ni = !1;
    Mi = Ni;
    var Oi, Pi = !1;
    Oi = Pi;
    var Qi, Ri = !1;
    ...
    function jj(a, b) {
        ej.hasOwnProperty(a) || (cj.set(a, b),
        Sc(xb(a, b), dj),
        fj())
    }
    function kj() {
    ...
    function qk() {
        ...
        if (a) {
            ...
            if (b.siloed) {
                ...
                g++)
                    f.hg = b.siloed[g],
                    !ck && db(f.hg.isDestination ? e : d, function(k) {
                        return function(m) {
                            return m === k.hg.ctid
                        }
                    }(f)) ? ck = !0 : c.push(f.hg);
    ...
    function rk() {
        ...
        if (a.pending) {
            ...
            k++)
                g.ff = a.pending[k],
                db(g.ff.target.isDestination ? f : e, function(m) {
                    return function(n) {
    ...
    function sk() {
        for (var a = Nf.ctid, b = dk(), c = gk(), d = function(n, p) {
            ...
            var J = p ? e.destination : e.container
              , F = J[n];
            F ? (p && F.state === 0 && S(93),
            Object.assign(F, q)) : J[n] = q
        }, e = Yj(), f = l(b), g = f.next(); !g.done; g = f.next())
            d(g.value, !1);
    ...
    ;var jl;
    try {
        jl = JSON.parse(Ra("eyIwIjoiSUQiLCIxIjoiSUQtSkIiLCIyIjpmYWxzZSwiMyI6Imdvb2dsZS5jby5pZCIsIjQiOiIiLCI1Ijp0cnVlLCI2IjpmYWxzZSwiNyI6ImFkX3N0b3JhZ2V8YW5hbHl0aWNzX3N0b3JhZ2V8YWRfdXNlcl9kYXRhfGFkX3BlcnNvbmFsaXphdGlvbiJ9"))
    } catch (a) {
        S(123),
        il(2),
        jl = {}
    ...
    var rl = [O.g.O, O.g.U, O.g.N, O.g.za], sl, tl;
    function ul(a) {
    ...
    ;function Ol() {
        if (Gi.pscdl !== void 0)
            Ll(Gl.uf) === void 0 && Kl(Gl.uf, Gi.pscdl);
        else {
            var a = function(c) {
                Gi.pscdl = c;
                Kl(Gl.uf, c)
            ...
            if (!(e && e.length > 1)) {
                ...
                for (n in f)
                    if (f.hasOwnProperty(n)) {
                        var p = gm(f[n], k);
                        p.length && (cm && console.log(p),
                        m.push(n))
                    }
                m.length && (em(b, m),
                Ua("TAGGING", $l[E.readyState] || 14));
                f[b] = k
            }
        }
    }
    ...
    function im() {
        Ek("tdc", function() {
            dm && (C.clearTimeout(dm),
            dm = void 0);
            var a = [], b;
            for (b in Yl)
                Yl.hasOwnProperty(b) && a.push(b + "*" + Yl[b].join("."));
    ...
    ;var jm = function(a, b, c, d, e, f, g, k, m, n, p) {
      ...
      , U = function(a, b, c, d) {
        for (var e = l(km(a, d === void 0 ? 3 : d)), f = e.next(); !f.done; f = e.next()) {
            var g = f.value;
            if (g[b] !== void 0)
                return g[b]
        }
      ...
      , nm = function(a) {
        for (var b = [O.g.Zc, O.g.Vc, O.g.Wc, O.g.Xc, O.g.Yc, O.g.bd, O.g.dd], c = km(a, 3), d = l(c), e = d.next(); !e.done; e = d.next()) {
    ...
    function Pm() {
        return [["v", "3"], ["t", "t"], ["pid", String(Nm)]]
    }
    var Qm = {};
    function Rm(a, b, c) {
        Oj && a !== void 0 && (Qm[a] = Qm[a] || [],
        Qm[a].push(c + b),
        Mm(a))
    }
    function Sm(a) {
    ...
    function Vm(a, b, c, d) {
        ...
        e && (Q(49) && Li && (d.deferrable = !0),
        Um.push("event", [b, a], e, d))
    }
    function Wm(a, b, c, d) {
        var e = Sl(c, d.isGtmEvent);
    ...
    bn.prototype.push = function(a, b, c, d) {
        c !== void 0 && (Ym(this, c).status === 1 && (Ym(this, c).status = 2,
        this.push("require", [{}], c, {})),
    ...
    bn.prototype.flush = function(a) {
        for (var b = this, c = [], d = !1, e = {}; this.commands.length; e = {
            ...
            if (f.messageContext.deferrable)
                !g || Ym(this, g).H ? (f.messageContext.deferrable = !1,
                ...
                case "config":
                    ...
                    k.H = !0;
                    n ? Sc(e.Jc, k.K) : (Sc(e.Jc, k.P[g.id]),
                    S(70));
                    d = !0;
                    break;
                case "event":
    ...
    var On = function(a) {
      ...
      , Nn = function(a, b) {
        ...
        if (c.fetch) {
            ...
            Mn(c, a, b === void 0 ? !1 : b, d === void 0 ? !1 : d)
    };
    var Pn = function() {
        this.P = this.P;
        this.C = this.C
    ...
    Rn.prototype.Ua = function() {
        this.aa = {};
        this.K && (hn(this.H, "message", this.K),
        delete this.K);
        delete this.aa;
        delete this.H;
        delete this.j;
    ...
    var Wn = function(a, b, c) {
        ...
        if (k === 0)
            ...
            m = k === 1 ? a.purpose && a.vendor ? Vn(a.purpose.legitimateInterests, b) && Vn(a.vendor.legitimateInterests, d === void 0 ? "755" : d) : !0 : !0;
        return m
    }
      , Vn = function(a, b) {
        return !(!a || !a[b])
                ...
                b.addEventListener(function(c) {
                    ...
                    !oo(c) || lo() || mo()) {
                        ...
                        if (d) {
                            ...
                            a.uc = d;
                            var q = {}
                              , r = (q[O.g.O] = a.uc["1"] ? "granted" : "denied",
                            q);
                            a.gdprApplies !== !0 ? (Dl([O.g.O, O.g.za, O.g.N]),
                            Nk().active = !0) : (r[O.g.za] = a.uc["3"] && a.uc["4"] ? "granted" : "denied",
                            typeof a.tcfPolicyVersion === "number" && a.tcfPolicyVersion >= 4 ? r[O.g.N] = a.uc["1"] && a.uc["7"] ? "granted" : "denied" : Dl([O.g.N]),
                            xl(r, {
                                eventId: 0
                            }, {
    ...
    function wo(a) {
        if (ll() === "US-CO" && fc.globalPrivacyControl === !0)
            return !1;
        var b = vo(a);
        if (b === 3)
            return !1;
    ...
    function yo() {
        var a = {}, b;
        for (b in uo)
            uo.hasOwnProperty(b) && (a[uo[b]] = Wk(b));
    ...
    function Co(a) {
        for (var b = "1", c = 0; c < so.length; c++) {
            var d = b, e, f = so[c], g = Uk.delegatedConsentTypes[f];
    ...
    function Ko(a) {
        ...
        Mi ? (c.og = Jo[b],
        c.og || (c.og = 0)) : c.og = Qi ? 13 : 10;
        Zi.H ? (c.mg = 0,
        c.Dl = 2) : Oi ? c.mg = 1 : Io() ? c.mg = 2 : c.mg = 3;
        var e = {};
        e[6] = ck;
        ...
        m === void 0 ? k = "" : (n || (n = 0),
        k = "" + He(1, 1) + Ee(m << 2 | n));
        var p = c.Dl, q = "4" + k + (p ? "" + He(2, 1) + Ee(p) : ""), r, u = c.fn;
        ...
        if (x && g) {
            ...
            w = "";
        var D = c.mn, I = c.Je, J = c.ya, F = c.io, Z = q + r + v + w + (D ? "" + He(6, 1) + Ee(D) : "") + (I ? "" + He(7, 3) + Ee(I.length) + I : "") + (J ? "" + He(8, 3) + Ee(J.length) + J : "") + (F ? "" + He(9, 3) + Ee(F.length) + F : ""), N;
        var W = c.Gl;
        W = W === void 0 ? {} : W;
    ...
    function vp(a, b) {
        var c = [fc.userAgent, (new Date).getTimezoneOffset(), fc.userLanguage || fc.language, Math.floor(pb() / 60 / 1E3) - (b === void 0 ? 0 : b), a].join("*"), d;
        if (!(d = ip)) {
    ...
    function Up(a, b) {
        var c = b.split(".");
        c.length === 5 ? (Mp[a] = c.slice(0, 2).join("."),
        Np[a] = {
            id: c.slice(2, 4).join("."),
            Yh: Number(c[4]) || 0
        }) : c.length === 3 ? Np[a] = {
    ...
    ;var fq = new Map([[5, "ad_storage"], [4, ["ad_storage", "ad_user_data"]]]);
    function gq(a) {
        if (cq[5]) {
    ...
    function pq(a) {
        if (a && typeof a === "object")
            if ("expires"in a && "value"in a) {
                ...
                !isNaN(b) && Date.now() <= b || (a.value = null,
                a.error = 9)
            } else
    ...
    function Kq(a, b) {
        ...
        c.Jd = b.Jd),
        c.Pa = c.Pa ? b.Pa ? c.timestamp < b.timestamp ? b.Pa : c.Pa : c.Pa || 0 : b.Pa || 0,
        c.labels = Jq(c.labels || [], b.labels || []),
        c.Sc = Jq(c.Sc || [], b.Sc || [])) : a.push(b)
    }
    function Lq() {
        var a = nq();
    ...
    function Pq(a, b, c, d, e, f) {
        ...
        c && k(c, "dc");
        d !== void 0 && rq.test(d) && (g.wbraid = d,
        k(d, "gb"));
        e !== void 0 && rq.test(e) && (g.gbraid = e,
        k(e, "ag"));
        f !== void 0 && rq.test(f) && (g.gad_source = f,
        k(f, "gs"));
        return g
    }
    function Rq(a) {
    ...
    function Sq(a, b, c, d, e) {
        ...
        var f = Bq(c.prefix)
          ...
          , q = function() {
            ...
            if (!p && a.gbraid && vq("ad_storage") && (p = !0,
            !n)) {
                var B = a.gbraid
                  , D = Cq("ag", f);
    ...
    function Uq(a, b, c, d) {
        if (a.gad_source !== void 0 && vq("ad_storage")) {
            var e = a.gad_source
              , f = Cq("gs", b);
            if (f) {
                var g = Math.round((pb() - (Fc() || 0)) / 1E3), k;
                if (Za(10)) {
                    var m, n = String, p = C.location.hostname, q = C.location.pathname, r = p = Bj(p);
        ...
        if (Mo(C)) {
            ...
            wq(function() {
                ib(d, function(f, g) {
                    ...
                    if (k.length) {
                        var m = k[0], n = Wq(m), p = Yq(m.split(".")).length !== 0 ? m.split(".").slice(3) : [], q = {}, r;
    ...
    function Or(a) {
        var b = Za(10), c = {}, d, e, f;
        Ir.test(E.location.host) && (d = Nr("gclgs"),
        e = Nr("gclst"),
        b && (f = Nr("gcllp")));
        if (d && e && (!b || f))
            c.Mh = d,
            ...
            m.length > 0 && n.length > 0 && (!b || p.length > 0) && (c.Mh = m.join("."),
            c.Oh = n.join("."),
    ...
    ;function es(a) {
        var b = U(a.m, O.g.Ob)
          , c = U(a.m, O.g.jc);
        b && !c ? (a.eventName !== O.g.ba && a.eventName !== O.g.Uc && S(131),
    ...
    function Au(a, b) {
        ...
        var k = g, m = ((k == null ? void 0 : k.length) || 0) >= (Ya[2] === void 0 ? 50 : Ya[2]), n;
        if (n = e.length >= 1) {
            var p = Number(e[e.length - 1].dataset.loadTime);
            p !== void 0 && pb() - p < (Ya[1] === void 0 ? 6E4 : Ya[1]) ? (Ua("TAGGING", 9),
            n = !0) : n = !1
        }
        if (!n) {
            if (c === 1)
    ...
    function Tw() {
        ...
        Pw.test(C.location && C.location.hostname) && (Mi ? S(116) : (S(117),
        Uw && (a = [],
        ...
        c ? S(8) : c = [];
        Pw.test(C.location && C.location.hostname) && (c = mb(c),
        ...
        return function(f) {
            ...
            var v = !m || q;
            v || !(k.indexOf("sandboxedScripts") >= 0) || b && b.indexOf("sandboxedScripts") !== -1 || (v = gb(d, Sw));
            return e[g] = v
        }
    }
    var Uw = !1;
    ...
    function Ww(a, b, c, d, e) {
        if (!Xw()) {
            ...
            if (!tk(f)) {
                ...
                if (!p) {
                    var q = Fi.vf + n;
                    m && ic && k ? (q = ic.replace(/^(?:https?:\/\/)?/i, "").split(/[?#]/)[0],
                    p = ps("https://", "http://", q + g)) : p = aj() ? $i() + "/" + g : ps("https://", "http://", q + g)
                }
                d.siloed && vk({
                    ctid: f,
                    isDestination: !1
    ...
    ;var ix = function(a, b) {
      ...
      , jx = function(a, b, c, d) {
        if (Ii.hasOwnProperty(b) || b === "__zone")
            return -1;
        var e = {};
        Rc(d) && (e = Sc(d, e));
        e.id = c;
    ...
    ;var Ex = {}
      ...
      , Gx = {};
    function Hx(a, b, c, d) {
        Oj && Q(90) && ((d === void 0 ? 0 : d) ? (Gx[b] = Gx[b] || 0,
        ++Gx[b]) : c !== void 0 ? (Fx[a] = Fx[a] || {},
        Fx[a][b] = Math.round(c)) : (Ex[a] = Ex[a] || {},
        Ex[a][b] = (Ex[a][b] || 0) + 1))
    }
    function Ix(a) {
        var b = a.eventId, c = a.Tc, d = Ex[b] || {}, e = [], f;
        for (f in d)
    ...
    function Jx(a) {
        var b = a.eventId, c = a.Tc, d = Fx[b] || {}, e = [], f;
        for (f in d)
            d.hasOwnProperty(f) && e.push("" + f + d[f]);
        c && delete Fx[b];
    ...
    function ey(a) {
        for (var b = [], c = 0; c < a.length; c++)
            if (a[c]) {
                ...
                if (Hi[d] || jf[c][Ie.rl] !== void 0 || Iw(d, 2))
                    b[c] = !0
            }
        return b
    }
    function fy(a, b) {
        if (!b)
            return b;
        for (var c = 0; c < a.length; c++)
            if (a[c] && jf[c] && !Ii[String(jf[c][Ie.oa])])
                return !0;
        return !1
    }
    var gy = 0;
      ...
      , Py = {
        config: function(a, b) {
            ...
            if (!(a.length < 2) && z(a[1])) {
                var d = {};
                if (a.length > 2) {
                    if (a[2] !== void 0 && !Rc(a[2]) || a.length > 3)
                        return;
                    d = a[2]
                }
                ...
                if (e) {
                    ...
                    if (u ? gk().indexOf(r) === -1 : dk().indexOf(r) === -1) {
                        ...
                        b.inheritParentConfig)) {
                            ...
                            var x = d;
                            Ly ? (My(b, Ly, x),
                            w = !1) : (!x[O.g.nc] && Ki && Ky || (Ky = Sc(x, null)),
                            w = !0);
        ...
        consent: function(a, b) {
            if (a.length === 3) {
                ...
                var c = Jy(a, b)
                  , d = a[1]
                  , e = a[2];
                b.fromContainerExecution || (e[O.g.N] && S(139),
                e[O.g.za] && S(140));
                d === "default" ? vl(e) : d === "update" ? xl(e, c) : d === "declare" && b.fromContainerExecution && ul(e)
            }
        },
        event: function(a, b) {
            var c = a[1];
            if (!(a.length < 2) && z(c)) {
                var d = void 0;
                if (a.length > 2) {
                    if (!Rc(a[2]) && a[2] !== void 0 || a.length > 3)
                        return;
                    d = a[2]
                }
                var e = d
        ...
        set: function(a, b) {
            var c = void 0;
            a.length === 2 && Rc(a[1]) ? c = Sc(a[1], null) : a.length === 3 && z(a[1]) && (c = {},
            Rc(a[2]) || Array.isArray(a[2]) ? c[a[1]] = Sc(a[2], null) : c[a[1]] = a[2]);
            if (c) {
                var d = Jy(a, b)
                  , e = d.eventId
                  , f = d.priorityId;
    ...
    function gz(a, b) {
        ...
        if (!a.event)
            return !1;
        typeof d !== "number" && (d = Xi(),
        a["gtm.uniqueEventId"] = d,
        jj("gtm.uniqueEventId", d));
        return by(a)
    }
    function hz(a) {
    ...
    ;function Xz() {
        var a = [["cv", Q(111) ? Wz() : "3"], ["rv", Fi.th], ["tc", jf.filter(function(b) {
            return b
        }).length]];
    ...
    function VB(a) {
        ...
        }, this.D, ub(oA(this).kb(), "__cvt_") ? 2 : 1)
    }
    VB.R = "createQueue";
    function WB(a, b) {
        var c = null;
    ...
    function kD(a) {
        return function() {
            if (a.limit && a.ai >= a.limit)
                a.lg && C.clearInterval(a.lg);
            else {
                a.ai++;
                var b = pb();
                ez({
    ...
    var Yb = ka(["data-gtm-yt-inspected-"]), nD = ["www.youtube.com", "www.youtube-nocookie.com"], oD, pD = !1;
    function zD(a, b) {
        var c = this;
        return b
    }
        ...
        for (var c = b.indexOf("\n\n"); c !== -1; ) {
            ...
            if (n) {
                ...
                if (p) {
                    var u = p || [];
                    if (Array.isArray(u))
                        for (var v = Rc(q) ? q : {}, t = l(u), w = t.next(); !w.done; w = t.next())
                            r(w.value, v)
                }
                ...
                if (x && A) {
                    var B = x || [];
                    if (Array.isArray(B))
                        for (var D = Rc(y) ? y : {}, I = l(B), J = I.next(); !J.done; J = I.next())
                            A(J.value, D)
                }
            }
            b = b.substring(c + 2);
    ...
    function() {
        ...
        (function(b) {
            ...
            if (d === "QUERY")
                ...
                f = tj(e, d, d == "HOST" ? b[a("vtp_stripWww")] : void 0, d == "PATH" ? b[a("vtp_defaultPages")] : void 0);
            return f
        })
    }();
    ...
    mK.onHtmlSuccess = Sz(!0),
    mK.onHtmlFailure = Sz(!1);
    function nK() {
        Gi[ik()] = Gi[ik()] || mK;
        sk();
        ...
        var a = mk(nk()), b, c = a == null ? void 0 : (b = a.context) == null ? void 0 : b.source;
        c !== 2 && c !== 4 && c !== 3 || S(142);
        Oz(),
        of({
            zm: function(d) {
    ...
    (function(a) {
        ...
        var g = function(v) {
            ...
            oc("https://" + Fi.vf + "/debug/bootstrap?id=" + Nf.ctid + "&src=" + w + "&cond=" + v + "&gtm=" + Ko()));
            var y = {
                ...
                if (Yj().canonical[g]) {
                    ...
                    if (Pj) {
                        ...
                        if (!Oe)
                            ...
                            var ho = eo;
                            ho && (Ek("rtg", String(Oe.canonicalContainerId)),
                            Ek("rlo", String(ho.bn)),
                        ...
                        var By = io;
                        By && Ek("pcid", By);
                        Q(34) && (Ek("bt", String(Zi.H ? 2 : Oi ? 1 : 0)),
