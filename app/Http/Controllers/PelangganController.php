        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ->addColumn('action', function($row){
                    $btn = '<button class="btn btn-outline-info show rounded-circle" data-id="'.$row->id.'">
                ...
                $btn .= '<button class="btn btn-outline-warning edit rounded-circle" data-id="'.$row->id.'" data-toggle="modal" data-target="#editModal">
                ...
                $btn .= '<button class="btn btn-outline-danger delete rounded-circle" data-id="'.$row->id.'">
